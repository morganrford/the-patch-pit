...
urlpatterns = [
    ...
    path('distros/<int:pk>/update/',
         views.DistroUpdate.as_view(), name='distro_update'),
    path('distros/<int:pk>/delete/',
         views.DistroDelete.as_view(), name='distro_delete'),
    path('patches/', views.patch_index, name='patch_index'),
    path('patches/create/', views.PatchCreate.as_view(), name='patch_create'),
    path('patches/<int:pk>/update/',
         views.PatchUpdate.as_view(), name='patch_update'),
    path('patches/<int:pk>/delete/',
         views.PatchDelete.as_view(), name='patch_delete'),
